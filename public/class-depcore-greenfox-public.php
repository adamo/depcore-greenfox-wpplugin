...
class Depcore_Greenfox_Public
{
	...
	public function display_product_information_greenfox()
	{
		...
		$metabox_group = [
			...
			'Logistics information' => ['EAN_of_unit_package', 'EAN_of_bulk_package', 'dimensions_of_unit_package_cm', 'dimensions_of_bulk_package_cm', 'logistics_minimum', 'number_of_layers_on_a_pallet', 'number_of_boxes_per_layer', 'number_of_boxes_per_pallet', 'pallet_weight', 'pallet_dimensions_cm'],
		];
	...
	{
		add_shortcode('greenfox_product_list', array($this, 'display_product_list'));
	}
	...
	{
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type(new Greenfox_Product_List_Widget());
	}
